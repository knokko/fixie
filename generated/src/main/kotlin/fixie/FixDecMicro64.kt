...
@Throws(FixedPointException::class)
operator fun Int.times(right: FixDecMicro64) = FixDecMicro64.from(this) * right

@Throws(FixedPointException::class)
operator fun Long.times(right: FixDecMicro64) = FixDecMicro64.from(this) * right

@Throws(FixedPointException::class)
operator fun Float.times(right: FixDecMicro64) = FixDecMicro64.from(this) * right

@Throws(FixedPointException::class)
operator fun Double.times(right: FixDecMicro64) = FixDecMicro64.from(this) * right
...
fun abs(value: FixDecMicro64) = FixDecMicro64.raw(kotlin.math.abs(value.raw))
