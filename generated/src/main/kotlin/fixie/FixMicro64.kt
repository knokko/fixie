...
@Throws(FixedPointException::class)
operator fun Int.times(right: FixMicro64) = right * this

@Throws(FixedPointException::class)
operator fun Long.times(right: FixMicro64) = right * this

@Throws(FixedPointException::class)
operator fun Float.times(right: FixMicro64) = right * this

@Throws(FixedPointException::class)
operator fun Double.times(right: FixMicro64) = right * this
