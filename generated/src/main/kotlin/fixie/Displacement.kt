...
value class Displacement internal constructor(val value: FixDisplacement) : Comparable<Displacement> {
	...
	@Throws(FixedPointException::class)
	operator fun div(right: Duration) = (this.toDouble(DistanceUnit.METER) / right.toDouble(DurationUnit.SECONDS)).mps
	...
	@JvmInline
	value class Area(val raw: Double) : Comparable<Area> {
		...
		override operator fun compareTo(other: Area) = this.raw.compareTo(other.raw)
	}
}
