...
@Throws(FixedPointException::class)
operator fun Int.times(right: FixCenti8U) = right * this

@Throws(FixedPointException::class)
operator fun Long.times(right: FixCenti8U) = right * this

@Throws(FixedPointException::class)
operator fun Float.times(right: FixCenti8U) = right * this

@Throws(FixedPointException::class)
operator fun Double.times(right: FixCenti8U) = right * this
