...
operator fun Int.times(right: FixUncheckedCenti8U) = right * this

operator fun Long.times(right: FixUncheckedCenti8U) = right * this

operator fun Float.times(right: FixUncheckedCenti8U) = right * this

operator fun Double.times(right: FixUncheckedCenti8U) = right * this
