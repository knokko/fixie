...
internal class NumberClassGenerator(
    ...
    private fun generateToString() {
        ...
        if (maybe10Power != null) {
            ...
            else "(BigInteger.valueOf($power) * BigInteger.TEN)"
            writer.println("\t\tval bigFract = BigInteger.valueOf((raw % RAW_ONE)$toLong) * $nextPower")
            writer.println("\t\tval fractNumber = bigFract / BigInteger.valueOf(RAW_ONE.toLong())")
