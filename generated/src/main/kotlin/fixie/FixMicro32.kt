...
@Throws(FixedPointException::class)
operator fun Int.times(right: FixMicro32) = right * this

@Throws(FixedPointException::class)
operator fun Long.times(right: FixMicro32) = right * this

@Throws(FixedPointException::class)
operator fun Float.times(right: FixMicro32) = right * this

@Throws(FixedPointException::class)
operator fun Double.times(right: FixMicro32) = right * this
...
@Throws(FixedPointException::class)
fun abs(value: FixMicro32) = if (value.raw != Int.MIN_VALUE) FixMicro32.raw(kotlin.math.abs(value.raw))
