...
class TestFixDisplacement {
	...
	fun testLongConversion() {
		...
		testOverflow(86400144687920885)
	...
	fun testFloatConversion() {
		...
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(-2175836.0f) }
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(4.61168608E8f) }
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(-4.61168608E8f) }
	}
	...
	fun testDoubleConversion() {
		...
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(-2175835.9089135965) }
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(4.61168601413242E8) }
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(-4.61168601413242E8) }
	}
	...
	fun testMultiplicationAndDivision() {
		...
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(-13729) * -2873 }
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(-2873) * 1367 }
		testValues(-2445, 0)
		testValues(-469, 1)
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(-250) * 1367 }
		testValues(-71, 0)
		testValues(-67, 182)
		testValues(-8, -469)
		testValues(0, 182)
		...
		assertThrows(FixedPointException::class.java) { FixDisplacement.from(182) * -250 }
		testValues(775, 1)
