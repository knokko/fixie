...
operator fun Int.times(right: FixUncheckedMicro64) = FixUncheckedMicro64.from(this) * right

operator fun Long.times(right: FixUncheckedMicro64) = FixUncheckedMicro64.from(this) * right

operator fun Float.times(right: FixUncheckedMicro64) = FixUncheckedMicro64.from(this) * right

operator fun Double.times(right: FixUncheckedMicro64) = FixUncheckedMicro64.from(this) * right
...
fun abs(value: FixUncheckedMicro64) = FixUncheckedMicro64.raw(kotlin.math.abs(value.raw))
