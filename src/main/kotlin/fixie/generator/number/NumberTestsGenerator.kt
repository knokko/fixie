...
internal class NumberTestsGenerator(
    ...
    private fun generateMultiplicationAndDivision() {
        ...
        fun randomValue() = if (number.internalType.signed) {
            ...
            uLongToBigInteger(rng.nextULong(bigIntegerToULong(number.oneValue / BigInteger.TWO), bigIntegerToULong(number.oneValue)))
        }
        ...
        writer.println("\t\tassertEquals(${number.className}.raw($random1$suffix), " +
